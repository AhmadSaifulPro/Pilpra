            ...
            <div class="row align-items-center text-center">
                <div class="col-md-12">
                    <div class="card-body">
                        ...
                        <h4 class="mb-5 f-w-400">Login Dewan Ambalan</h4>
                        <form action="{{ route('do_logindewanambalan') }}" method="POST">
                            @csrf
                            ...
                            <button class="btn btn-block mb-4 rounded" style="background-color:#E48900;color: white;" type="submit">Login</button>
                            </p>
                        </form>
                    </div>
                </div>
